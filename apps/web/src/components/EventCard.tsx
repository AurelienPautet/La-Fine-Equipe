...
const EventsCard: React.FC<{
  ...
  return (
    <div
      className={`relative card bg-base-100 shadow-md hover:shadow-xl transition-all duration-300 border border-base-300/50 hover:border-primary/50 overflow-hidden h-full flex flex-col cursor-pointer ${className}`}
    >
      <Link
      ...
      <div className="card-body flex flex-col justify-between p-3 sm:p-4 md:p-6 gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="card-actions flex flex-row flex-nowrap mt-2 sm:mt-3 relative z-10">
          <Link
            to={`/events/${events.slug}`}
